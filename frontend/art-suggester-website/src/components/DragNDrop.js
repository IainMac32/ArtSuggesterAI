...
const DragNdrop = ({ uploadFile, setUploadFile }) => {
  ...
  const onDrop = useCallback(acceptedFiles => {
    ...
    acceptedFiles.forEach(file => {
      // logic for choosing which file to set as uploadFile
    })
  ...
  return (
    <div className={`drop-container ${isDragActive ? "container-drag-active" : ""}`}>
          ...
          {isDragActive ? (
            ...
            <div className="drop-default-div">
              ...
              <div className="upload-icon">
                ...
                { uploadFile != null ? (
                  <p>Received file: {uploadFile.path}</p>
                ) : (
